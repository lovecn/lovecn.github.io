<?php /* Smarty version 2.6.25, created on 2013-03-13 06:53:00
...
<table border="1" width="80%" height="80%" cellspacing=0 cellpadding=0 style="valign：middle;margin:auto" align='center'>
	<form name='form' method='post' id='post'>
		...
		<tr>
			<td colspan='9' style='background:repeat-x 0 -222px;' align='center'>
...
" id='del'>
 ...
 <tr>
	<td colspan='9' align='center'>总共<font size="30px" color="red"><?php echo $this->_tpl_vars['pageTotal']; ?>
...
" id='del'>
	...
	<?php endforeach; endif; unset($_from); ?>
 <tr>
	<td colspan='8' align='center'>总共<font size="30px" color="red"><?php echo $this->_tpl_vars['page_Total']; ?>
</font>页&nbsp;当前是第<font size="30px" color="red"><?php echo $this->_tpl_vars['page']; ?>
</font>页&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
