<?php /* Smarty version 2.6.25, created on 2013-04-08 01:09:54
...
<table border="1" width="80%" height="80%" cellspacing=0 cellpadding=0 style="valign：middle;margin:auto" align='center'>
	...
	<tr>
       <td  colspan='6' class='player' valign="middle"  align='center'><?php echo $this->_tpl_vars['time']; ?>
播出选手统计信息</td>
	</tr>
...
<tr>
	<td colspan='5' align='center'>共<font size="30px" color="red"><?php echo $this->_tpl_vars['pageTotal']; ?>
