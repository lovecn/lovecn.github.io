<?php /* Smarty version 2.6.25, created on 2013-03-19 01:48:24
...
?> 
		<tr>
			<td colspan='2' align='center'><?php if (isset ( $this->_tpl_vars['player_id'] )): ?>播出选手资料修改<?php else: ?>海选选手资料修改<?php endif; ?></td>
		</tr>
		<?php if (isset ( $this->_tpl_vars['player_id'] )): ?>
		<tr>
